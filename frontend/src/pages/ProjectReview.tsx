        ...
        <div className="flex flex-col gap-6 animate-fade-in">
            <div className="bg-gray-800 p-6 rounded-xl border border-gray-700 shadow-lg flex gap-4 items-end">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-purple-600 hover:bg-purple-500 text-white rounded-lg font-bold transition-all disabled:bg-gray-700 disabled:text-gray-500 shadow-lg shadow-purple-900/50"
                >
                    <Send size={18} /> {isLoading ? 'Đang quét toàn bộ hệ thống...' : 'Phân tích Kiến trúc'}
                </button>
            </div>
            ...
            <div className="bg-gray-800 p-8 rounded-xl border border-gray-700 min-h-[400px] shadow-lg">
                {!reviewText && !isLoading && !error && (
                    <div className="text-gray-500 flex flex-col justify-center items-center h-full gap-3 mt-20">
                        ...
                        <p>Chế độ quét sâu: AI sẽ tự động đoán ngôn ngữ và đánh giá kiến trúc toàn bộ dự án.</p>
                    </div>
                )}
